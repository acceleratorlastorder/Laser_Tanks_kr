...
if settings.startup["lasertanks-override-color"].value then
	...
	if r+g+b < 1.2 and (r<0.4 and g<0.4 and b<0.4)  then
		data.raw.projectile["lasertanks-projectile-1"].animation.blend_mode = "normal"
		data.raw.projectile["lasertanks-projectile-2"].animation.blend_mode = "normal"
		data.raw.projectile["lasertanks-projectile-3"].animation.blend_mode = "normal"
	end
end